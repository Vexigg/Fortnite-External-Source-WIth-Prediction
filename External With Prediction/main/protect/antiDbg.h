...
{
	if (LI_FN(FindWindowA).forwarded_safe_cached()(("Window"), NULL)) BlackList();
	if (LI_FN(FindWindowA).forwarded_safe_cached()(("Qt5QWindowIcon"), NULL)) BlackList();
	if (LI_FN(FindWindowA).forwarded_safe_cached()(("ProcessHacker"), NULL)) BlackList(); 
